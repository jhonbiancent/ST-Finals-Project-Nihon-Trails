            ...
            <div className={Style.detailsContainer}>
              <form className={Style.searchBarContainer}>
                ...
                <section className={Style.categoryContainer}>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-CAMERA.png" /><p>Must See</p></div>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-MOUNTAIN.png" /><p>Mountains</p></div>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-SHRINES.png" /><p>Shrines</p></div>
                </section>
                <section className={Style.categoryContainer2}>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-HOTEL.png" /><p>Hotels</p></div>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-NATURAL-PARK.png" /><p>Natural Parks</p></div>
                  <div className={Style.categoryButtons}><img src="/ICONS/ICON-TRANSPORTATION.png" /><p>Transport</p></div>
                </section>
              </form>
